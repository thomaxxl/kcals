...
projectname="kcals"  # lower case, only
resourcegroup="kcals_rg"
...
# git clone https://github.com/apilogicserver/kcals.git
# cd kcals
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name kcals --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
