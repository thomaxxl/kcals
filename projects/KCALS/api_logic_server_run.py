...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 10.02.05, February 24, 2024 06:37:24):
...
app_logger.info(f'Created February 24, 2024 06:37:24 at {str(current_path)}\n')
